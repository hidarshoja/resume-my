...
export const translations = {
  en: {
    ...
    contact: {
      ...
      collaborateTitle: "Let's build something together",
      location: 'Location',
      locationValue: 'Iran — remote & hybrid friendly',
      availability: 'Available for work',
      responseTime: 'Usually replies within 6 hours',
      preferredContact: 'Fastest way to reach me (Telegram & Phone)',
      channels: 'Contact channels',
      copy: 'Copy',
      copied: 'Copied!',
      formNote: 'Submitting opens your email app with a pre-filled message.',
      helpWith: 'I can help with',
      helpList: ['Frontend products', 'FinTech UI', 'Bilingual systems', 'Performance audits'],
      form: {
        name: 'Your Name',
        email: 'Your Email',
  ...
  fa: {
    ...
    contact: {
      ...
      eyebrow: 'آماده فرصت‌های جدید',
      collaborateTitle: 'بیایید با هم چیزی بسازیم',
      location: 'موقعیت',
      locationValue: 'ایران — ریموت و هیبرید',
      availability: 'آماده همکاری',
      responseTime: 'معمولاً تا ۶ ساعت پاسخ می‌دهم',
      preferredContact: 'سریع‌ترین راه ارتباط (تلگرام و تماس)',
      channels: 'راه‌های ارتباطی',
      copy: 'کپی',
      copied: 'کپی شد!',
      formNote: 'با ارسال، برنامه ایمیل شما با پیام از پیش‌نوشته باز می‌شود.',
      helpWith: 'می‌توانم کمک کنم در',
      helpList: ['محصولات فرانت‌اند', 'UI فین‌تک', 'سیستم‌های دوزبانه', 'بهینه‌سازی عملکرد'],
      form: {
        name: 'نام شما',
        email: 'ایمیل شما',
        message: 'پیام شما',
        send: 'ارسال پیام',
        subject: 'درخواست همکاری از',
      },
      info: {
        phone: 'تلفن',
        email: 'ایمیل',
